...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // --- część bazodanowa
    String url = "jdbc:sqlserver://LAPTOP-NL30FP2S;encrypt=true;databaseName=master;trustServerCertificate=true;user=user;password=Witam123;";/*<-- tu należy wpisać URL bazy danych */
